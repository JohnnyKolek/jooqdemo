...
public class Author extends TableImpl<AuthorRecord> {
    ...
    /**
     * The column <code>public.author.surname</code>.
     */
    public final TableField<AuthorRecord, String> SURNAME = createField(DSL.name("surname"), SQLDataType.VARCHAR.nullable(false), this, "");

    private Author(Name alias, Table<AuthorRecord> aliased) {
        this(alias, aliased, null);
    }

    public Author(Name alias, Table<AuthorRecord> aliased, Field<?>[] parameters) {
