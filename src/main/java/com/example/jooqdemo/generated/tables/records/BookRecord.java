...
public class BookRecord extends UpdatableRecordImpl<BookRecord> implements Record3<Integer, String, Integer> {
    ...
    /**
     * Setter for <code>public.book.id_author</code>.
     */
    ...
    /**
     * Getter for <code>public.book.id_author</code>.
     */
     ...
     */
    public BookRecord(Integer id, String title, Integer idAuthor) {
        super(Book.BOOK);
